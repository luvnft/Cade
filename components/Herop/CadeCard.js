...
const CadeCard = () => {
    ...
    return (
        <>
            <div>
                <h1 className='flex justify-start text-6xl text-orange-400 font-abc'>Arcade Card</h1>
                <div class="w-auto h-56 border-2 border-gray-200 relative bg-center bg-[url('/ig.png')] object-center bg-no-repeat lg:h-1/2 p-6 mt-5 from-gray-300 to-purple-800 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
