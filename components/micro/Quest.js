  ...
  return (
    <>
      <div className="p-12 md:w-1/2 flex flex-col items-start">
        ...
        <h2 className="text-5xl font-abc title-font font-medium text-white mt-4 mb-4">
          ...
          <div className="flex-grow">
            ...
            <ul className="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
              ...
              <li className="flex items-center">
                ...
                <h1 className="text-3xl font-abc text-white">
                  Open 3 Blind Chest and 1 Blind Bag
                </h1>
              </li>
              <li className="flex items-center">
                <svg
                ...
                <h1 className="text-3xl font-abc text-white">
                  Login For 7 Continous Days and refer 2 Friends
                </h1>
              </li>
            </ul>
            ...
            <label
              ...
              className="font-abc text-4xl block mt-5 mb-2 font-medium text-gray-900 dark:text-white"
            >
              Completed
            </label>
            <input
              ...
              max="10"
              value="5"
              className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-yellow-300"
              onChange={() => {
                console.log("Quest");
              }}
            />
