    ...
    return (
        <>
            <div class="p-12 md:w-1/2 flex flex-col items-start">
                ...
                <h2 class="text-5xl font-abc title-font font-medium text-white mt-4 mb-4">Uncompleted Quest</h2>
                <div class="flex border-2 rounded-lg border-white  p-8 sm:flex-row flex-col">
                    ...
                    <div class="flex-grow">
                        <h2 class="text-white text-3xl font-abc title-font font-medium mb-3">Uncompleted Quest</h2>
                        ...
                        <h1 className='mt-2 text-white font-abc text-3xl'>33/100</h1>

                        <p className="leading-relaxed font-abc text-2xl mt-2 text-white">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine.</p>
                    </div>
                </div>
