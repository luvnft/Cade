            ...
            <div class="p-12 md:w-1/2 flex flex-col items-start">
                ...
                <div class="flex border-2 rounded-lg border-white p-8 sm:flex-row flex-col">
                    ...
                    <div class="flex-grow">
                        ...
                        <button class="bg-transparent ml-5 hover:bg-blue-500 text-white font-semibold hover:text-white py-2 px-4 border border-white hover:border-transparent rounded">
                            LeaderBoard
                        </button>
                        </div>
                        <h2 class="text-white text-base title-font font-medium mb-3">1,093,531</h2>
