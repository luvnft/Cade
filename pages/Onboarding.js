    ...
    <>
      ...
      <div class="relative flex flex-col min-h-screen bg-[url('/brickwall.jpg')]">
          ...
          <div class="block lg:hidden h-screen flex flex-col overflow-y-scroll">
            ...
            <div class="mt-10 flex flex-col justify-center">
              ...
              <div class="flex flex-row justify-center">
                <div>
                  <button type="button" class="mt-5 font-abc text-4xl bg-gray-950 text-white border-2 border-yellow-400 focus:outline-none rounded-lg px-3 py-3 me-2 mb-2"><Link href='/'>Join Cade </Link></button>
                </div>
                <div>
                  <button type="button" class="mt-5 font-abc text-4xl bg-gray-950 text-white border-2 border-yellow-400 focus:outline-none rounded-lg px-3 py-3 me-2 mb-2"><Link href='/'>To Arcade</Link></button>
                </div>
              </div>
        ...
        <div class="hidden lg:flex flex-col h-3/4 overflow-y-hidden mt-5">
            ...
            <div class="flex justify-center w-3/5 mb-14">
              <div class="w-2/4 flex flex-col justify-center items-center">
                ...
                <div class="flex flex-row">
                  <div>
                    <button type="button" class="mt-5 font-abc text-4xl bg-gray-950 text-white border-2 border-yellow-400 focus:outline-none rounded-lg px-5 py-5 me-2 mb-2"><Link href='/'>Join Cade </Link></button>
                  </div>
                  <div>
                    <button type="button" class="mt-5 font-abc text-4xl bg-gray-950 text-white border-2 border-yellow-400 focus:outline-none rounded-lg px-5 py-5  me-2 mb-2"><Link href='/'>To Arcade</Link></button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="h-1/2 flex flex-row bg-transparent overflow-x-scroll">
