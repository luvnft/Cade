          ...
          <div class="lg:w-2/3 md:w-1/2 rounded-lg overflow-hidden sm:mr-10 ">
                ...
                <div class="container px-5 py-10 mx-auto">
                  <div class="flex flex-wrap -m-4 text-center">
                    <div class="p-4 sm:w-1/4 w-1/2">
                      <h2 class="font-abc title-font font-medium sm:text-4xl text-3xl text-white">FourInLine</h2>
            ...
            <>
              ...
              <div className='ml-5 flex justify-center'>
                <button class="py-3 text-black font-abc bg-white border-0  px-6 m-2 focus:outline-none rounded text-2xl"
                >
                  <Link href="http://localhost:3000/Games/FourInLine">Back to home</Link>
                </button>
              </div>
            </>
