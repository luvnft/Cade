...
const user_for_createMap = ""
const map_for_createGame = ""
              ...
              <div className=" mx-auto">
                <div className="flex items-center space-x-5">
                  ...
                  <div className="block pl-2 font-semibold text-xl self-start text-gray-700">
                    <h2 className="leading-relaxed mt-8">For createMap instructions</h2>
                ...
                <div className="divide-y divide-gray-200">
                  ...
                  <div className="pt-4 flex items-center space-x-4">
                    ...
                    onClick={
                      ()=>createMap(program , name_for_createMap , board_for_createMap , budget_for_createMap ,  map_for_createMap   , user_for_createMap   ,   systemProgram ,)
                    }
                    >
              ...
              <div className=" mx-auto">
                ...
                <div className="divide-y divide-gray-200">
                  ...
                  <div className="pt-4 flex items-center space-x-4">
                    ...
                    className="bg-blue-500 flex justify-center items-center w-full text-white px-3 text-xl py-1 rounded-md focus:outline-none"
                    onClick={
                      ()=>createGame(program ,  map_for_createGame   , game_for_createGame   , user_for_createGame   ,   systemProgram ,)
                    }
                    >
